...
-- CreateEnum
CREATE TYPE "ExperienceLevel" AS ENUM ('BEGINNER', 'INTERMEDIATE', 'PROFESSIONAL');

-- CreateEnum
CREATE TYPE "TradingStyle" AS ENUM ('SCALPING', 'DAY_TRADING', 'SWING_TRADING', 'POSITION_TRADING');
...
CREATE TABLE "User" (
    ...
    "analysisCountDate" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
